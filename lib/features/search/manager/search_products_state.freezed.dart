...
part of 'search_products_state.dart';
...
/// @nodoc
abstract class $SearchProductsStateCopyWith<T, $Res> {
  factory $SearchProductsStateCopyWith(
    SearchProductsState<T> value,
    $Res Function(SearchProductsState<T>) then,
  ) = _$SearchProductsStateCopyWithImpl<T, $Res, SearchProductsState<T>>;
}

/// @nodoc
class _$SearchProductsStateCopyWithImpl<
  T,
  $Res,
  $Val extends SearchProductsState<T>
>
    implements $SearchProductsStateCopyWith<T, $Res> {
...
class __$$IdleImplCopyWithImpl<T, $Res>
    extends _$SearchProductsStateCopyWithImpl<T, $Res, _$IdleImpl<T>>
...
class _$IdleImpl<T> implements Idle<T> {
  ...
  @override
  String toString() {
    return 'SearchProductsState<$T>.idle()';
  }
...
abstract class Idle<T> implements SearchProductsState<T> {
...
class __$$LoadingImplCopyWithImpl<T, $Res>
    extends _$SearchProductsStateCopyWithImpl<T, $Res, _$LoadingImpl<T>>
...
class _$LoadingImpl<T> implements Loading<T> {
  ...
  @override
  String toString() {
    return 'SearchProductsState<$T>.loading()';
  }
...
abstract class Loading<T> implements SearchProductsState<T> {
...
class __$$LoadingMoreImplCopyWithImpl<T, $Res>
    extends _$SearchProductsStateCopyWithImpl<T, $Res, _$LoadingMoreImpl<T>>
...
class _$LoadingMoreImpl<T> implements LoadingMore<T> {
  ...
  @override
  String toString() {
    return 'SearchProductsState<$T>.loadingMore(data: $data)';
  }
...
abstract class LoadingMore<T> implements SearchProductsState<T> {
...
class __$$SuccessImplCopyWithImpl<T, $Res>
    extends _$SearchProductsStateCopyWithImpl<T, $Res, _$SuccessImpl<T>>
...
class _$SuccessImpl<T> implements Success<T> {
  ...
  @override
  String toString() {
    return 'SearchProductsState<$T>.success(data: $data)';
  }
...
abstract class Success<T> implements SearchProductsState<T> {
...
class __$$ErrorImplCopyWithImpl<T, $Res>
    extends _$SearchProductsStateCopyWithImpl<T, $Res, _$ErrorImpl<T>>
...
class _$ErrorImpl<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'SearchProductsState<$T>.error(networkExceptions: $networkExceptions)';
  }
...
abstract class Error<T> implements SearchProductsState<T> {
